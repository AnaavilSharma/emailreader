...
def mainFn():
    ...
    def cancel_action():
        ...
        if selected_day is not None:
            ...
            if selected_day in events_dict:
                del events_dict[selected_day]
            preview_var.set(f"Removed the event of: {selected_day} {calendar.month_name[current_month]}, {current_year}")
